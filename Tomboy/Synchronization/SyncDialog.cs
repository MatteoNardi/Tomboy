...
: base (string.Empty,
		        ...
		        Gtk.DialogFlags.DestroyWithParent)
		{
			...
			//TODO: replace with a good value for progressBar.PulseStep
...
public SyncTitleConflictDialog (Note existingNote, IList<string> noteUpdateTitles) :
		base (Catalog.GetString ("Note Conflict"), null, Gtk.DialogFlags.Modal)
		{
			...
			renameOptionsVBox.PackStart (renameEntry, true, true, 0);
			//renameOptionsVBox.PackStart (renameUpdateCheck); // This seems like a superfluous option
			renameHBox.PackStart (renameRadio, true, true, 0);
			renameHBox.PackStart (renameOptionsVBox, true, true, 0);
			ContentArea.PackStart (renameHBox, true, true, 0);
			...
			ContentArea.PackStart (deleteExistingRadio, true, true, 0);

			alwaysDoThisCheck = new Gtk.CheckButton (Catalog.GetString ("Always perform this action"));
			ContentArea.PackStart (alwaysDoThisCheck, true, true, 0);
